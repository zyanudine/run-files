# 200917_M00662_0358_000000000-G63G6
...
cpdir="/mnt/win-hp1/next_gene_seq_wind/share/Miseq_panel_ABL1_rmdup"
project=200917_M00662_0358_000000000-G63G6    # change project name
...
nohup bash ./codes/Miseq-general-ROVER-ABL1-rmdup.sh $dtype $project $alg $samples $run $ext $cptype $cpdir $roi $roi_mergesort $reffai $hotspot $pairallelecount $gn2NM 2>&1 | nohup tee -a tmp/$project.nohup
