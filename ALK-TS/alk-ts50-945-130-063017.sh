# TS50 945-130, remove sample check now
...
# codes/utils/get_bar.sh Auto_user_945-130-Pfizer_ALK_phase_II_June_batch_26Jun2017_lib_202_164 ALK_AmpliSeq_run_barcode_sample_key_sheet.txt
---------
#varscan
---
cdl
