# TS50 945-196, remove sample check now
...
# codes/utils/get_bar.sh Auto_user_945-196-ALK_primer_controls_requalification_271_263 ALK_AmpliSeq_run_barcode_sample_key_sheet.txt
---------
#varscan
---
cdl
...
project=Auto_user_945-196-ALK_primer_controls_requalification_271_263
