# TS32 945-64, remove sample check now
...
# codes/utils/get_bar.sh Auto_user_945-64-ALK_NGS_HiQ_view_validation_gb2_H3122_dilutions_129_072 ALK_AmpliSeq_run_barcode_sample_key_sheet.txt
---------
#varscan
---
cdl
