# TS50 945-99, remove sample check now
...
# codes/utils/get_bar.sh Auto_user_945-99-ALK_NGS_phase_II_libs_9Jan2017_WL_166_113 ALK_AmpliSeq_run_barcode_sample_key_sheet.txt
---------
#varscan
---
cdl
