# 171019_M00662_0189_000000000-BGHPD
...
# mkdir -p seqs/171019_M00662_0189_000000000-BGHPD/fq
# cp -pr /mnt/win-hp/base_space/BMD_TruSight_Re-run1-50059016/*/*/*fastq.gz seqs/171019_M00662_0189_000000000-BGHPD/fq/
# gunzip seqs/171019_M00662_0189_000000000-BGHPD/fq/*
...
cpdir=Miseq_panel_BMD
project=171019_M00662_0189_000000000-BGHPD    # change project name
...
pairallelecount=n
gn2NM=NVS_genes_and_refRNA_accession_NM_number_BMD.xls

nohup bash ./codes/Miseq-general-ROVER-BMD.sh $dtype $project $alg $samples $run $ext $cptype $cpdir $roi $roi_mergesort $reffai $hotspot $pairallelecount $gn2NM 2>&1 | nohup tee -a tmp/$project.nohup
