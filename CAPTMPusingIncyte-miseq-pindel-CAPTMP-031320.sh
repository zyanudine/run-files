...
project=200313_M00000_0001_000000000-CAPTMP    # change project name
...
control_run=200313_M00000_0001_000000000-CAPTMP
#control_name=NVSC4
...
nohup bash ./codes/Miseq-general-pindel-CAPTMP.sh $dtype $project $alg $samples $run $ext $cptype $cpdir $roi $reffai $control_run $control_name 2>&1 | nohup tee -a tmp/$project.nohup
