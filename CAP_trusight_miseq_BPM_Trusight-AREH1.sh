# BPM_Trusight-AREH1 (basespace OCT/18/16)
# 3/9/17 cp from Novartis_Myloid-ampliseq-miseq-bwamem-varscanFLT3-rover*.sh, for CAP trusight miseq run
...
# mkdir -p seqs/BPM_Trusight-AREH1/fq
# cp -pr /mnt/win-hp/base_space/BPM_Trusight-32983954/*/*fastq.gz seqs/BPM_Trusight-AREH1/fq/
# gunzip seqs/BPM_Trusight-AREH1/fq/*
...
cpdir=Miseq_BPM_Trusight
project=BPM_Trusight-AREH1    # change project name
