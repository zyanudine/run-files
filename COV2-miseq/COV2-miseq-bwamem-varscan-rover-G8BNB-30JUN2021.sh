# 210629_M70777_0027_000000000-G8BNB
# 5/10/21 cp from run-files/ABL1-miseq/ABL1-miseq-bwamem-varscan-rover-G63G6-092120.sh for COV2, use miseq fastq
...
# mkdir -p seqs/210629_M70777_0027_000000000-G8BNB/fq
# rsync -avls BaseSpace/Projects/COVIDseq-p386-29Jun2021-WLI/Samples/*/*/*fastq.gz seqs/210629_M70777_0027_000000000-G8BNB/fq/
# gunzip seqs/210629_M70777_0027_000000000-G8BNB/fq/*
...
cpdir="/mnt/win-hp1/next_gene_seq_wind/share/Miseq_panel_COV2"
project=210629_M70777_0027_000000000-G8BNB    # change project name
#roi=TruSight_MMD_calculated_ROI.merge.bed
roi=COV2_ROI.bed
roi_mergesort=COV2_ROI.bed
reffai=cov2/cov2_sequences_bwa7.12
...
nohup bash ./codes/Miseq-general-ROVER-COV2.sh $dtype $project $alg $samples $run $ext $cptype $cpdir $roi $roi_mergesort $reffai $hotspot $pairallelecount $gn2NM 2>&1 | nohup tee -a tmp/$project.nohup
