#!/bin/bash
shopt -s extglob
# 230214_M70771_0088_000000000-GFGB4  # real miseq run, change run name, bed, ref, aln etc.
...
# rsync -avls 'BaseSpace/Projects/MICA-Batch3-13Feb2023-LS'/Samples/*/*/*fastq.gz seqs/230214_M70771_0088_000000000-GFGB4/fq/ or
...
project=230214_M70771_0088_000000000-GFGB4    # change project name
roi=MICA.bed
