#!/bin/bash
shopt -s extglob
# 230502_M70777_0081_000000000-GH6PW  # real miseq run, change run name, bed, ref, aln etc.
...
# mkdir -p seqs/230502_M70777_0081_000000000-GH6PW/fq
# rsync -avls /mnt/miseqdx18/Illumina/MiSeqAnalysis/230502_M70777_0081_000000000-GH6PW/Alignment_1/20230215_074159/Fastq/*fastq.gz seqs/230502_M70777_0081_000000000-GH6PW/fq/
# gunzip seqs/230502_M70777_0081_000000000-GH6PW/fq/*
# 3/23/23 cp from basemount as alternative
# rsync -avls 'BaseSpace/Projects/MICA-Batch4-02May2023-WL'/Samples/*/*/*fastq.gz seqs/230502_M70777_0081_000000000-GH6PW/fq/ or
...
project=230502_M70777_0081_000000000-GH6PW    # change project name
roi=MICA.bed
