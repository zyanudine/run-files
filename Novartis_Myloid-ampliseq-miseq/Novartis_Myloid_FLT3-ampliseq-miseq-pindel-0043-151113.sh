# 151119_M00662_0043_000000000-AK240, use MSR2.2 from bam file
...
project=151119_M00662_0043_000000000-AK240    # change project name
roi=CHP2.20131001.designed.merge.bed   # does not matter
reffai=miseq-hg19-genome.fa
nohup bash ./codes/Miseq-general-pindel.sh $dtype $project $alg $samples $run $ext $cptype $cpdir $roi $reffai 2>&1 | nohup tee -a tmp/$project.nohup
