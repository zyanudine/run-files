...
cpdir=/mnt/win-hp3_1/NGS_Cambridge/NGS_share/TSO500_ctDNA_ESR1
...
nohup bash $workdir/codes/Miseq-general-tso500_ctDNA_ESR1.sh $dtype $project $alg $samples $run $ext $cptype $cpdir $roi $roi_mergesort $reffai $hotspot $pairallelecount \
