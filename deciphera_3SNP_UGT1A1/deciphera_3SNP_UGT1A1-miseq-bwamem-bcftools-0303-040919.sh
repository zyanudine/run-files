#!/bin/bash
shopt -s extglob
# 190408_M00662_0303_000000000-G3LVC  # real miseq run, change run name, bed, ref, aln etc.
...
# ls /mnt/win-hp/base_space -ltrh   to check download folder
...
# rsync -avl /mnt/win-hp/base_space/Deciphera_PROJ0370_08Apr2019-127149026/*/*/*fastq.gz seqs/190408_M00662_0303_000000000-G3LVC/fq/
# mkdir -p seqs/190408_M00662_0303_000000000-G3LVC/fq
# cp -pr /mnt/win-hp/base_space/Deciphera_PROJ0370_08Apr2019-127149026/*/*/*fastq.gz seqs/190408_M00662_0303_000000000-G3LVC/fq/
# gunzip seqs/190408_M00662_0303_000000000-G3LVC/fq/*
...
project=190408_M00662_0303_000000000-G3LVC    # change project name
