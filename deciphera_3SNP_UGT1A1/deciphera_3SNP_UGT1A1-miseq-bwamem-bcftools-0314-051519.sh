#!/bin/bash
shopt -s extglob
# 190514_M00662_0314_000000000-G3VCW  # real miseq run, change run name, bed, ref, aln etc.
...
# mkdir -p seqs/190514_M00662_0314_000000000-G3VCW/fq
# cp -pr /mnt/win-hp/base_space/PROJ0375C_Deciphera_Run1-132543418/*/*/*fastq.gz seqs/190514_M00662_0314_000000000-G3VCW/fq/
# gunzip seqs/190514_M00662_0314_000000000-G3VCW/fq/*
...
project=190514_M00662_0314_000000000-G3VCW    # change project name
