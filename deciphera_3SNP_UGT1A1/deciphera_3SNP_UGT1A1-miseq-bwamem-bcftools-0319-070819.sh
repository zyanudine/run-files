#!/bin/bash
shopt -s extglob
# 190703_M00662_0319_000000000-G3W94  # real miseq run, change run name, bed, ref, aln etc.
...
# mkdir -p seqs/190703_M00662_0319_000000000-G3W94/fq
# cp -pr /mnt/win-hp/base_space/PROJ0375C_Deciphera_Run3-138038902/*/*/*fastq.gz seqs/190703_M00662_0319_000000000-G3W94/fq/
# rsync -avls /mnt/win-hp/base_space/PROJ0375C_Deciphera_Run3-138038902/*/*/*fastq.gz seqs/190703_M00662_0319_000000000-G3W94/fq/
# gunzip seqs/190703_M00662_0319_000000000-G3W94/fq/*
...
project=190703_M00662_0319_000000000-G3W94    # change project name
...
project=$projectorig
cpdir=/mnt/win-hp1/next_gene_seq_wind/share/Miseq_deciphera_3snp
nohup bash $workdir/codes/Miseq-deciphera_3SNP-reprot.sh $project $alg $cpdir 2>&1 | nohup tee -a tmp/$proj
