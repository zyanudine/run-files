#!/bin/bash
shopt -s extglob
# 200807_M00662_0356_000000000-G66BR  # real miseq run, change run name, bed, ref, aln etc.
...
# mkdir -p seqs/200807_M00662_0356_000000000-G66BR/fq
# cp -pr /mnt/win-hp/base_space/Deciphera_PROJ0370_20Mar2019-123353428/*/*/*fastq.gz seqs/200807_M00662_0356_000000000-G66BR/fq/
#   7/23/20 cp from basemount now
# rsync -avls 'BaseSpace/Projects/Deciphera UGT1A1 clinical sample 05Aug2020'/Samples/*/*/*fastq.gz seqs/200807_M00662_0356_000000000-G66BR/fq/
# gunzip seqs/200807_M00662_0356_000000000-G66BR/fq/*
...
project=200807_M00662_0356_000000000-G66BR    # change project name
