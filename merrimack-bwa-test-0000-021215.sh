...
# it is merrimack bwa alignment in ouput/xxx using old pipleine, then moved to seq/xxx/Alignment_bwa
------
cdl
...
project=141125_M00000_00merrimackbwa01_A000000000-00000-merrimack-bwa    # change project name
