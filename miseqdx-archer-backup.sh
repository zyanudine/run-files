...
# 12/9/19 cp from run-files/miseqdx-archer-s3.sh for miseqdx archer backup to network share, see Miseqdx-archerdx_backup.sh
...
s3in="/mnt/win-hp3/ArcherDX-Merck/Insight2_trial_MS200095-0031"    # s3://compote-cam01-prod-seq-output-s3/
...
nohup bash $workdir/codes/Miseqdx-archerdx_backup.sh $miseqdx $runfrom $samplesheet $s3in $s3out $outs $proj_flt $sharef 2>&1 | nohup tee -a tmp/Miseqdx-archerdx_s3.nohup
...
runfrom=compare                                 # “samplesheet” or “compare” compare miseqdx /mnt/miseqdx1x/Illumina/MiSeqOutput/ from s3 bucket
samplesheet=miseqdx-run-samplesheet.txt         # miseqdx-run-samplesheet.txt
s3in="/mnt/win-hp3/ArcherDX-Merck/Vision2_trial_MS200095-0022"    # s3://metex14-cam01-prod-seq-output-s3
...
proj_flt="ivd-reveal-ctdna_METex14\|ivd-reveal-ctdna_HaveWeMET\|ivd-reveal-rna_METex14" # filter project with key word in SampleSheet.csv "ivd-reveal-ctdna", or "ivd-reveal-ctdna_METex14","ivd-reveal-ctdna_HaveWeMET","ivd-reveal-rna_METex14", "ivd-reveal-ctdna_HaveWeMET\|ivd-reveal-rna_METex14"
sharef="/mnt/win-hp1"                           # share folder /mnt/win-hp etc.
