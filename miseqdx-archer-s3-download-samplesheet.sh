...
proj_flt="ivd-reveal-ctdna_HaveWeMET\|ivd-reveal-rna_METex14" # filter project with key word in SampleSheet.csv "ivd-reveal-ctdna", or "ivd-reveal-ctdna_METex14", "ivd-reveal-ctdna_HaveWeMET","ivd-re$
sharef="/mnt/win-hp1"                           # share folder /mnt/win-hp etc.
