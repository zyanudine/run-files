...
proj_flt="MRD-TS-Run\|AML-MRD"		        	# filter project with key word in SampleSheet.csv "MRD-TS-Run\|AML-MRD"
sharef="/mnt/win-hp1"   		        # share folder /mnt/win-hp etc.

nohup bash $workdir/codes/Nextseq-twinstrand_dnanexus-auto-run.sh $nextseqdx $runfrom $samplesheet $proj_flt $sharef 2>&1 | nohup tee -a tmp/nextseq-twinstrand_dnanexus.nohup
