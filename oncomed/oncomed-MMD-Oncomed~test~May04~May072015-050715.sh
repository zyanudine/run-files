#MMD-Oncomed~test~May04~May072015, trimmed from May04 (ogap, varscan), untrimmed bam from May07 (TSVC, trim in vc)
#varscan after TS4.2.1
--
cdl
dtype=bam_bai
plgin=variantCaller   # does not matter
cpdir=ONCOMED_AmpliSeq_test_nohotspot
project=Auto_user_MMD-Oncomed~test~May04~May072015-Ampliseq_panel
samples=all
ext=null
reffai=hg19.fasta
