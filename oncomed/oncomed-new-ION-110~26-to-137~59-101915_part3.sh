#Ion-110~26 to Ion-137~59, 34 runs, 69 bams/barcodes, see codes/prjts/oncomed_123gene_ampliseq_new.sh
#untrim-ogap-varscan+TSVCtrim
#-----------------
#varscan after TS4.2.1
#--
for x in `ls seqs/ | grep Auto_user_ION | sort -t_ -k3.9,3.10n | awk 'NR>=36 && NR<=40'`
do
echo $x
