#138~60, see codes/prjts/oncomed_123gene_ampliseq_new.sh
#untrim-ogap-varscan+TSVCtrim
#-----------------
#varscan after TS4.2.1
#--
#x=Auto_user_ION-138~60-RP219_OncoMed_Grp2_Pool11_460
for x in `ls seqs/ | grep Auto_user_ION | sort -t_ -k3.9,3.10n | awk 'NR==60'`
do
echo $x
