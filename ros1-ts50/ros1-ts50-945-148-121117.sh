# TS50 ROS1 panel run 945-148, remove sample check now
...
# codes/utils/get_bar.sh Auto_user_945-148-PROJ212_ROS1_NGS_set-2_PF_219_183 ROS1_AmpliSeq_run_barcode_sample_key_sheet.txt
---------
#varscan
---
cdl
...
cpdir=ROS1_TS5.0
project=Auto_user_945-148-PROJ212_ROS1_NGS_set-2_PF_219_183
samples=all
ext=null
reffai=hg19.fasta
