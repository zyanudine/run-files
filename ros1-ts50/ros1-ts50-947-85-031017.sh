# TS50 ROS1 panel run 947-85, remove sample check now
...
# codes/utils/get_bar.sh Auto_user_947-85-PROJ211_ROS1_ValSet-1_PF_160_155 ROS1_AmpliSeq_run_barcode_sample_key_sheet.txt
---------
#varscan
---
cdl
...
cpdir=ROS1_TS5.0
project=Auto_user_947-85-PROJ211_ROS1_ValSet-1_PF_160_155
samples=all
ext=null
reffai=hg19.fasta
