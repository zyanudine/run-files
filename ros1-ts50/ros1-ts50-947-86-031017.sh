# TS50 ROS1 panel run 947-86, remove sample check now
...
# codes/utils/get_bar.sh Auto_user_947-86-PROJ211_ROS1_ValSet-2_PF_159_ra1_157 ROS1_AmpliSeq_run_barcode_sample_key_sheet.txt
---------
#varscan
---
cdl
...
cpdir=ROS1_TS5.0
project=Auto_user_947-86-PROJ211_ROS1_ValSet-2_PF_159_ra1_157
samples=all
ext=null
reffai=hg19.fasta
