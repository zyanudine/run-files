# TS50 ROS1 panel run 947-87, remove sample check now
...
# codes/utils/get_bar.sh Auto_user_947-87-PROJ211_ROS1_ValSet-3_PF_161_158 ROS1_AmpliSeq_run_barcode_sample_key_sheet.txt
---------
#varscan
---
cdl
...
cpdir=ROS1_TS5.0
project=Auto_user_947-87-PROJ211_ROS1_ValSet-3_PF_161_158
samples=all
ext=null
reffai=hg19.fasta
